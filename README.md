...
![Illustration](https://github.com/user-attachments/assets/018a3a5e-3c3d-4390-bbc0-f78f7fc4e218)
...
The hack was buit for AC `13.0.2_LockdownEdition`. It may not work on other versions.
...
### Compilation
Please note that **i686-w64-mingw32-gcc is needed** to compile.<br>
<br>Run `make` in the root directory to generate the binary.

### Execution
Launch the game<br>
Launch `run.exe` (`./run.exe` in console or double click it)<br>
In a game:
- [F1] infinite ammo ON/OFF
- [F2] infinite health ON/OFF
- [F3] ESP ON/OFF
